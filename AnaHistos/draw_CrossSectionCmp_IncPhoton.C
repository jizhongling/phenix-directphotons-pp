...
void draw_CrossSectionCmp_IncPhoton()
{
  const char *pname[3] = {"PbSc West", "PbSc East", "PbGl"};

  double gx[4][npT] = {}, gy[4][npT] = {}, egy[4][npT] = {};
  for(int part=0; part<4; part++)
    ReadGraph<TGraphErrors>("data/CrossSection-incphoton.root", part, gx[part], gy[part], egy[part]);
  ...
  c0->Print("plots/CrossSectionCmpParts-incphoton.pdf");
  //c1->Print("plots/CrossSectionCmpCombined-incphoton.pdf");
}
