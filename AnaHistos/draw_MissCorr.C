...
void draw_MissCorr()
{
  ...
  QueryTree *qt_misscorr = new QueryTree("data/MissCorr.root", "RECREATE");
  ...
  for(int ipt=0; ipt<npT; ipt++)
    ...
    {
      double xpt, Miss, eMiss, Merge2, eMerge2, Merge1, eMerge1, BadPass, eBadPass;
      ...
      double MissCorr = Miss / Conv[part];
      double eMissCorr = MissCorr * sqrt( pow(eMiss/Miss,2) + pow(eConv[part]/Conv[part],2) );
      ...
      qt_misscorr->Fill(ipt, part, xpt, MissCorr, eMissCorr);
