void draw_Smear_pT()
{
  ...
  f[0] = new TFile("/phenix/plhf/zji/github/phenix-directphotons-pp/fun4all/offline/analysis/Run13ppDirectPhoton/AnaFastMC-macros/AnaFastMC-Fast-histo.root");
  ...
  for(int i=0; i<2; i++)
  {
    ...
    for(int part=0; part<1; part++)
    {
      ...
      for(int ipt=24; ipt<26; ipt+=2)
      {
        ...
        //mcd(i, ipad++);
        double pTlow = h_pt1->GetXaxis()->GetBinLowEdge(ipt+1);
        double pTup = h_pt1->GetXaxis()->GetBinUpEdge(ipt+2);
