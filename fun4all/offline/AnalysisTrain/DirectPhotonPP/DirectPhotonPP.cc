...
int DirectPhotonPP::Init(PHCompositeNode *topNode)
{
...
int DirectPhotonPP::InitRun(PHCompositeNode *topNode)
{
  if ( !_emcrecalib )
  {
...
int DirectPhotonPP::process_event(PHCompositeNode *topNode)
{
  _ievent++;
...
/* ----------------------------------------------- */
int DirectPhotonPP::FillTriggerEfficiency( emcClusterContainer *data_emccontainer, PHGlobal *data_global, ErtOut *data_ert )
{
  /* retrieve all histograms used in this function */
...
int DirectPhotonPP::FillClusterPtSpectrum( emcClusterContainer *data_emccontainer, PHGlobal *data_global )
{
...
int DirectPhotonPP::FillClusterTofSpectrum( emcClusterContainer *data_emccontainer, PHGlobal *data_global , string quali )
{
...
int DirectPhotonPP::FillPi0InvariantMass( emcClusterContainer *data_emccontainer, PHGlobal *data_global,
    TrigLvl1* data_triggerlvl1, ErtOut *data_ert, string quali )
{
  /* retrieve all histograms used in this function */
...
int DirectPhotonPP::FillPhotonPtSpectrum( emcClusterContainer *d_emccontainer, PHCentralTrack* d_tracks, PHGlobal *d_global )
{
...
int DirectPhotonPP::End(PHCompositeNode *topNode)
{
...
void DirectPhotonPP::ReadTowerStatus(const string &filename)
{
...
void DirectPhotonPP::ReadSashaWarnmap(const string &filename)
{
  unsigned int nBadSc = 0;
  unsigned int nBadGl = 0;
...
/* ----------------------------------------------- */
int DirectPhotonPP::get_tower_status( int sector, int ybin, int zbin )
{
  try
  {
...
bool DirectPhotonPP::testGoodTower( emcClusterContent *emccluster )
{
...
bool DirectPhotonPP::testTightFiducial( emcClusterContent *emccluster )
{
  int status = get_tower_status(
      anatools::CorrectClusterSector( emccluster->arm() , emccluster->sector() ),
      emccluster->iypos(),
...
bool DirectPhotonPP::testPhoton( emcClusterContent *emccluster , double bbct0 )
{
...
bool DirectPhotonPP::testDirectPhoton( emcClusterContent *emccluster , double bbct0 )
{
...
bool DirectPhotonPP::testIsolatedPhoton( emcClusterContent *emccluster0 ,
...
bool DirectPhotonPP::testPhotonEnergy( emcClusterContent *emccluster )
{
...
bool DirectPhotonPP::testPhotonTof( emcClusterContent *emccluster , double bbct0 )
{
...
bool DirectPhotonPP::testPhotonShape( emcClusterContent *emccluster )
{
...
bool DirectPhotonPP::testPhotonTrackVeto( emcClusterContent *emccluster )
{
