...
namespace anatools
{
  ...
  inline void TowerLocation(const PhotonMB *photon, int &sector, int &ytower, int &ztower)
  {
    int towerid = photon->get_towerid();
    TowerLocation(towerid, sector, ytower, ztower);
  ...
  inline int GetSector(const PhotonMB *photon)
  {
    int towerid = photon->get_towerid();
    int sector, ytower, ztower;
    TowerLocation(towerid, sector, ytower, ztower);
  ...
  inline TLorentzVector Get_pE(const PhotonMB *photon)
  {
    double x = photon->get_x();
    double y = photon->get_y();
    double z = photon->get_z();
  ...
  inline double Get_pT(const PhotonMB *photon)
  {
    TLorentzVector pE = Get_pE(photon);
    return pE.Pt();
  }

  inline double GetTot_pT(const PhotonMB *photon1, const PhotonMB *photon2)
  {
    TLorentzVector pE1 = Get_pE(photon1);
    TLorentzVector pE2 = Get_pE(photon2);
    return (pE1+pE2).Pt();
  ...
  inline double GetInvMass(const PhotonMB *photon1, const PhotonMB *photon2)
  {
    TLorentzVector pE1 = Get_pE(photon1);
    TLorentzVector pE2 = Get_pE(photon2);
    return (pE1+pE2).M();
  ...
  inline double GetAsymmetry_E(const PhotonMB *photon1, const PhotonMB *photon2)
  {
    double E1 = photon1->get_E();
    double E2 = photon2->get_E();
    double asymE = std::abs(E1 - E2) / std::abs(E1 + E2);
