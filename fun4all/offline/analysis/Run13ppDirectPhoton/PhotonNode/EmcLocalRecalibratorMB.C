...
EmcLocalRecalibratorMB::EmcLocalRecalibratorMB() :
  _file_tofmap(""),
...
void EmcLocalRecalibratorMB::ApplyClusterCorrection( PhotonContainerMB *photoncont )
{
...
double EmcLocalRecalibratorMB::GetCorrectedEcore( const PhotonMB *photon )
{
...
double EmcLocalRecalibratorMB::GetCorrectedTof(const PhotonMB *photon)
{
...
void EmcLocalRecalibratorMB::ReadEnergyCorrection(const int& a_runnumber)
{
...
void EmcLocalRecalibratorMB::ReadTofCorrection( const int& a_fillnumber )
{
  if( _file_tofmap == "" )
  {
