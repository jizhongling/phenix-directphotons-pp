...
#
root -b -q plot_warnmap2D.C\(\"warnmap-output/Warnmap_Run13pp510MinBias_ybins1to3_nsigma10_niter10.txt\",true\)
root -b -q plot_warnmap2D.C\(\"warnmap-output/Warnmap_Run13pp510MinBias_ybins5to5_nsigma10_niter10.txt\",true\)
